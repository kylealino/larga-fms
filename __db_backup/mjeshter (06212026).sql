...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2026 at 03:07 PM
...
('2026', '06', '15', '001', '00000000', '00000000', '00000000', '00000000', '00000000', '00000000', '00000000', '00000000', '00000000', '00000000', '000000');
...
('2026', '06', '15', '002', '00000000', '00000000', '00000000', '00000000', '00000000', '00000000', '00000000', '00000000', '00000000', '00000000', '000000');
...
(61, '2026-06-15', 'CD-001', '5010', 6000.00, 'Apparel Supplier', 'Stock In: COKE (30 pcs @ ₱200.00)', 'ADMIN', '2026-06-15 13:42:38');
...
(282, '2026-06-15', 'POS06152026001', '4010-MEMBERSHIP', 1000.00, 'ADMIN', '2026-06-15 13:35:15'),
(283, '2026-06-15', 'POS06152026002', '4010-MEMBERSHIP', 5000.00, 'ADMIN', '2026-06-15 13:41:14');
...
(101, 29, '0007519496', '2026-06-15 13:35:11', NULL, NULL, 'RFID', NULL, NULL, 'Active', NULL, NULL, NULL, '2026-06-15 05:35:11', NULL, NULL, 0),
(102, 29, '0007519496', '2026-06-15 13:41:10', '2026-06-21 20:06:09', NULL, 'RFID', NULL, NULL, 'Completed', NULL, NULL, NULL, '2026-06-15 05:41:10', NULL, NULL, 0),
(103, 29, '0007519496', '2026-06-21 20:06:15', '2026-06-21 20:06:55', NULL, 'RFID', NULL, NULL, 'Completed', NULL, NULL, NULL, '2026-06-21 12:06:15', NULL, NULL, 0),
(104, 29, '0007519496', '2026-06-21 20:07:01', '2026-06-21 20:10:22', NULL, 'RFID', NULL, NULL, 'Completed', NULL, NULL, NULL, '2026-06-21 12:07:01', NULL, NULL, 0),
(105, 29, '0007519496', '2026-06-21 20:10:29', '2026-06-21 20:10:58', NULL, 'RFID', NULL, NULL, 'Completed', NULL, NULL, NULL, '2026-06-21 12:10:29', NULL, NULL, 0),
(106, 29, '0007519496', '2026-06-21 20:14:51', '2026-06-21 20:15:39', NULL, 'RFID', NULL, NULL, 'Completed', NULL, NULL, NULL, '2026-06-21 12:14:51', NULL, NULL, 0),
(107, 29, '0007519496', '2026-06-21 20:15:45', NULL, NULL, 'RFID', NULL, NULL, 'Active', NULL, NULL, NULL, '2026-06-21 12:15:45', NULL, NULL, 0);
...
(85, 29, 'COKE', 'IN', 30, 'STOCK IN', 'STOCKIN-001', 'NEW ADDED PRODUCT', 'ADMIN', '2026-06-15 13:42:38'),
(86, 29, 'COKE', 'ADJUSTMENT', -5, 'ADJUSTMENT', 'ADJUSTMENT-001', 'Lost / Missing', 'ADMIN', '2026-06-15 13:42:56');
...
INSERT INTO `tbl_memberships` (`recid`, `member_id`, `membership_plan`, `membership_start_date`, `membership_end_date`, `membership_status`, `created_by`, `created_at`) VALUES
(8, 29, '1 Month', '2026-06-15', '2026-06-15', 'Expired', '', '2026-06-15 13:35:11'),
(9, 29, '6 Months', '2026-06-15', '2026-12-15', 'Active', '', '2026-06-15 13:41:10');
...
INSERT INTO `tbl_pos_dt` (`recid`, `postrxno`, `item_name`, `item_type`, `item_paytype`, `item_qty`, `item_amount`, `created_by`, `created_at`) VALUES
(202, 'POS06152026001', 'Membership - ALINO, KYLE', 'MEMBERSHIP', '', 1, 1000.00, 'ADMIN', '2026-06-15 13:35:11'),
(203, 'POS06152026002', 'Membership - ALINO, KYLE', 'MEMBERSHIP', '', 1, 5000.00, 'ADMIN', '2026-06-15 13:41:10');
...
(85, 'POS06152026001', 'Cash', 1000.00, 0.00, 1000.00, 'ADMIN', '2026-06-15 13:35:15'),
(86, 'POS06152026002', 'Cash', 5000.00, 0.00, 5000.00, 'ADMIN', '2026-06-15 13:41:14');
...
CREATE TABLE `tbl_products` (
  ...
  `reorder_level` int(1) NOT NULL DEFAULT 25,
  `created_by` varchar(50) DEFAULT NULL,
  `created_at` datetime DEFAULT current_timestamp(),
...
(29, 'COKE', 'Merchandise', 200.00, 400.00, 25, 'ACTIVE', 25, 'ADMIN', '2026-06-15 13:42:38', '2026-06-15 13:42:56');
...
--
ALTER TABLE `tbl_cash_disbursement_journal`
  MODIFY `journal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `tbl_cash_receipts_journal`
--
ALTER TABLE `tbl_cash_receipts_journal`
  MODIFY `journal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=284;
...
--
ALTER TABLE `tbl_checkin_history`
  MODIFY `checkin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
...
--
ALTER TABLE `tbl_memberships`
  MODIFY `recid` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tbl_pos_dt`
  MODIFY `recid` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=204;

--
-- AUTO_INCREMENT for table `tbl_pos_payment`
--
ALTER TABLE `tbl_pos_payment`
  MODIFY `recid` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
