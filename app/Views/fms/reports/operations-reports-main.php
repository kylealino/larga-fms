...
<style>
    ...
    .btn-toolbar.active { border-color: var(--primary); color: #ffffff; background: var(--primary); }
...
<div class="report-tabs" id="reportTabs">
    <button class="report-tab active" data-report="trip_report" onclick="__OperationsReports.load(this)">
        <i class="bi bi-signpost-2"></i> Trip Report
    </button>
    <button class="report-tab" data-report="dispatch_report" onclick="__OperationsReports.load(this)">
        <i class="bi bi-truck"></i> Dispatch Report
    </button>
    <button class="report-tab" data-report="truck_utilization" onclick="__OperationsReports.load(this)">
        <i class="bi bi-truck-front"></i> Truck Utilization
    </button>
    <button class="report-tab" data-report="driver_performance" onclick="__OperationsReports.load(this)">
        <i class="bi bi-person-badge"></i> Driver Performance
    </button>
    <button class="report-tab" data-report="helper_assignment" onclick="__OperationsReports.load(this)">
        <i class="bi bi-people"></i> Helper Assignment
    </button>
    <button class="report-tab" data-report="fuel_consumption" onclick="__OperationsReports.load(this)">
        <i class="bi bi-fuel-pump"></i> Fuel Consumption
    </button>
    <button class="report-tab" data-report="fuel_cost" onclick="__OperationsReports.load(this)">
        <i class="bi bi-cash-coin"></i> Fuel Cost
    </button>
</div>
...
<div class="filter-bar">
    ...
    <div class="filter-group">
        <button class="btn-primary-sm" onclick="__OperationsReports.applyFilters()">
            <i class="bi bi-funnel"></i> Apply Filters
        </button>
    </div>
    <div class="filter-group">
        <button class="btn-outline-sm" onclick="__OperationsReports.printPdf()">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h6 id="reportTitle"><i class="bi bi-table me-2"></i>Trip Report</h6>
...
window.addEventListener('load', function() {
    ...
    s.src = '<?=base_url('assets/js/apps/fms/reports/operations-reports.js');?>';
