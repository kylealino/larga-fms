...
<div class="report-tabs" id="reportTabs">
    <button class="report-tab active" data-report="delivery_report" onclick="__DeliveryReports.load(this)">
        <i class="bi bi-truck"></i> Delivery Report
    </button>
    <button class="report-tab" data-report="dr_report" onclick="__DeliveryReports.load(this)">
        <i class="bi bi-receipt"></i> DR Report
    </button>
    <button class="report-tab" data-report="pod_monitoring" onclick="__DeliveryReports.load(this)">
        <i class="bi bi-file-earmark-check"></i> POD Monitoring
    </button>
    <button class="report-tab" data-report="delivery_performance" onclick="__DeliveryReports.load(this)">
        <i class="bi bi-speedometer2"></i> Delivery Performance
    </button>
    <button class="report-tab" data-report="partial_failed_delivery" onclick="__DeliveryReports.load(this)">
        <i class="bi bi-exclamation-triangle"></i> Partial / Failed Delivery
    </button>
</div>
...
<div class="filter-bar">
    ...
    <div class="filter-group">
        <button class="btn-primary-sm" onclick="__DeliveryReports.applyFilters()">
            <i class="bi bi-funnel"></i> Apply Filters
        </button>
    </div>
    <div class="filter-group">
        <button class="btn-outline-sm" onclick="__DeliveryReports.printPdf()">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h6 id="reportTitle"><i class="bi bi-table me-2"></i>Delivery Report</h6>
...
window.addEventListener('load', function() {
    ...
    s.src = '<?=base_url('assets/js/apps/fms/reports/delivery-reports.js');?>';
