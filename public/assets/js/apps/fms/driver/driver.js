    ...
    this.__openDispatchModal = function(trip_id) {
        ...
        jQuery.ajax({
            ...
            success: function(data) {
                ...
                // Get trip info and assignment for display
                var tripParam = {
                    trip_id: trip_id,
                    meaction: 'GET_TRIP'
                };
                ...
                jQuery.ajax({
                    ...
                    success: function(tripData) {
                        if(tripData) {
                            ...
                            $('#dispatch_origin_display').text(tripData.origin || '—');
                            $('#dispatch_destination_display').text(tripData.destination || '—');
                            ...
                            jQuery.ajax({
                                ...
                                success: function(assignData) {
                                    ...
                                    if(assignData && assignData.assignment_id) {
                                        // Display and populate based on vehicle type
                                        var vehicleDisplay = '';
                                        ...
                                        // Auto-populate dispatch fields from assignment
                                        ...
                                        // No assignment found - show message
                ...
                if(data && data.dispatch_id) {
                    ...
                    // Only override if dispatch has values
                    ...
                    // Don't clear truck/driver/helper/origin/destination - they were populated from assignment
                    $('#odometer_out').val('');
                    $('#fuel_level_out').val('');
